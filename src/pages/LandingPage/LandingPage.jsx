    ...
    return (
        <>
            ...
            <div className="container container-atas">
                <div className="row row-atas d-flex align-items-center">
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-6">
                        <img src={hero} alt="gambar atas" width="600px" height="600px" className="gambar-atas" />
                    </div>
                </div>
            </div>
            {/* Keindahan Indonesia */}
            <div className="keberagaman">
                ...
                <div className="container">
                    <div className="row row-keberagaman">
                        <div className="col-sm-12 col-md-12 col-lg-6">
                            <img src={hero2} alt="gambar atas" width="500px" height="500px" />
                        </div>
                        <div className="col-sm-12 col-md-12 col-lg-6">
            ...
            {/* Keindahan Indonesia */}
            <div className="container keindahan-indonesia">
                <div className="row d-flex align-items-center">
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-6">
                        <img src={hero3} alt="gambar atas" width="600px" height="600px" className="ms-0" />
                    </div>
                </div>
            </div>
